...
2026-09-10 - operations control plane - persist frozen session-bound side effects with automatic/confirm/blocked policy, exact-operation approval/denial, bounded waitForOperation, and crash-safe no-replay recovery
